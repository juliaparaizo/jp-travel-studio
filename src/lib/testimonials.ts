...
export const testimonials: Testimonial[] = [
  {
    ...
    context: "grupo da Amazônia, 2026",
...
being in a girls-only group made the trip even more special. we welcomed each other, connected and had so much fun. i'd do it again a thousand and one times!!! eternal gratitude`,
  ...
  },
  {
    name: "Giovana",
    destination: "lencois",
    context: "Grupo de Lençóis Maranhenses, 2026",
    ...
    contextEn: "Lençóis Maranhenses group, 2026",
  ...
  },
  {
    name: "Ayla",
    destination: "lencois",
    context: "grupo de Lençóis Maranhenses",
    ...
    contextEn: "Lençóis Maranhenses group",
  ...
  },
  {
    ...
    contextEn: "Guatemala group, 2026",
