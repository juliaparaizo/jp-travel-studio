...
const content = {
  ...
  stamp: {
    pt: "cobro R$ 250 pelo serviço de curadoria e planejamento de itinerário, do começo ao fim de cada viagem.",
    en: "i charge R$ 250 for the itinerary curation and planning service, from the beginning to the end of every trip.",
  },
  script: {
